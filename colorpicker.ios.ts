...
export class ColorPicker {
  ...
  public show(initialColor: string = '#FF4081', colorMode: any = 'RGB') {
    return new Promise((resolve, reject) => {
      try {
          ...
          colorViewControllerDidChangeColor(colorViewCntroller, color) {
            ...
            switch (colorMode) {
              ...
              case 'RGB':
                ...
                break;
              case 'HEX':
                ColorPicker.COLOR = this.rgb2hex(red + ', ' + green + ', ' + blue + ', ' + alpha);
                break;
              default:
        ...
        let doneBtn = UIBarButtonItem.alloc().initWithTitleStyleTargetAction('Done', UIBarButtonItemStyleDone, this._impl, 'dismissViewController');
  ...
  _dismissViewController(sender) {
    ...
    topmost().currentPage.ios.dismissViewControllerAnimatedCompletion(true, null);
  }
